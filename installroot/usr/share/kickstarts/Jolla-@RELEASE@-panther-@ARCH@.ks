# DisplayName: Jolla panther/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: panther
# DeviceVariant: panther
# Brand: Jolla
...
repo --name=adaptation-common-panther-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-panther-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-panther
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/panther
